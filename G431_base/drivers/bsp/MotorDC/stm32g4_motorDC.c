...
void BSP_MOTOR_demo(void)
{
	...
	right_motor_id = BSP_MOTOR_add(GPIOB, GPIO_PIN_0, GPIOB, GPIO_PIN_4);	//le choix des broches est stratégiques : elles doivent correspondre à des TIMERS !
	left_motor_id = BSP_MOTOR_add(GPIOA, GPIO_PIN_9, GPIOA, GPIO_PIN_12);
